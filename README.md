...
## 機能一覧
- ログイン・ユーザー登録を搭載（deviseを導入 （就業コース 技術））
   - 名前、メールアドレス、パスワードは必須
   - プロフィール編集機能
   - プロフィール画像をアイコンとして設定ができる（carrierwaveを導入 （就業コース 技術））

- コメント機能
   - 投稿に対して他のユーザーがコメントできる。Ajaxを活用。（就業コース 技術）

- お気に入り機能（就業コース 技術）

- 投稿検索機能（ransackを導入（就業コース 技術））
...
![ER図](app/assets/images/ER図_5.png)
