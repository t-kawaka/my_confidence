class TasksController < ApplicationController
  ...
  def task_params
    params.require(:task).permit(:title, :description, :start_time, :notice, :require_time, :progress, :rate, points_attributes: [:name],tag_ids: []).merge(user_id: current_user.id)
  end
